...
<head>
    ...
    <title>Ingresar &mdash; Tejidos Caymi</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        input[type="password"]::placeholder { color: var(--sand-dark); }
        ...
        .forgot-link:hover { color: var(--ink); border-bottom-color: var(--sand-dark); }
        ...
        .register-hint a { color: var(--teal); text-decoration: none; border-bottom: 1px solid transparent; transition: border-color 0.2s; }
        .register-hint a:hover { border-bottom-color: var(--teal); }
...
<body>
    ...
    <div class="page-body">
        ...
        <div class="form-panel">
            ...
            <div class="form-eyebrow">Acceso al catálogo</div>
